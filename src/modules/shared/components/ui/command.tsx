...
function CommandItem({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Item>) {
	return (
		<CommandPrimitive.Item
			...
			className={cn(
				"data-[selected=true]:bg-foreground/5 data-[selected=true]:text-foreground typography-body-sm relative flex cursor-pointer items-center gap-2.5 rounded-xl px-4 py-3 outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}
		/>
